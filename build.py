...
def main():
    ...
    command = f'{pyinstaller_path} --noconfirm --onefile --noconsole --add-data=minibuster.ico;minibuster.ico --add-data=lib;lib --add-data=static;static --add-data=templates;templates'
